...
--
-- Priced today:   Amina Model, at 42,000.
-- Not yet priced: Partner Sales (284 rows) and Hakimi Partner (25 rows) on the
--                 file in hand. Their rows are refused one at a time with a
--                 reason naming this setting, rather than the file being
--                 refused whole - so the 674 Amina rows land while these wait
--                 on a number.
--
