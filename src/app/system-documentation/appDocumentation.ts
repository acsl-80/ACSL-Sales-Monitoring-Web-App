// Single source of truth for the in-app handover documentation.
// Rendered by SystemDocumentationContent.tsx and offered as a Markdown download.

export const DOC_LAST_UPDATED = "2026-08-06";

export const APP_DOCUMENTATION = String.raw`# ACSL Stove Sales & Transactions Platform — Handover Documentation
