...
- [ ] F2b The transfer's order model (D19): additive columns on stove_transfer_history written by both ERP syncs, exposed on v_transfers, preselected on the bench and shown in the rail and the sheet. host lane on his word. in progress
