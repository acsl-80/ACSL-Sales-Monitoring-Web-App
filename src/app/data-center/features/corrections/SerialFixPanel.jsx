...
/**
 * A disputed stove ID never goes through `update-sale`: the sales app treats
  ...
  return (
    <section className="overflow-hidden rounded-xl border border-gray-200 border-t-[3px] border-t-amber-500 bg-white shadow-sm">
      <header className="border-b border-gray-100 bg-amber-50 px-4 py-2.5">
        <h2 className="text-sm font-semibold text-gray-900">Fix the stove ID</h2>
        <p className="mt-0.5 text-xs text-gray-600">
          The record carries <span className="font-mono">{currentSerial ?? "no stove ID"}</span>. Move it onto the ID on the plate; the module checks the stove is free and swaps the records.
        </p>
      </header>
      <div className="p-4">
